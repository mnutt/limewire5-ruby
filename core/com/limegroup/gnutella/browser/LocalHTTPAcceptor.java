...
//    private static final String MAGNET_PAUSE = "/magnet10/pause";
    ...
    private class ScriptAssetHandler extends SimpleNHttpRequestHandler {
        public ConsumingNHttpEntity entityRequest(HttpEntityEnclosingRequest request,
                HttpContext context) throws HttpException, IOException {
        ...
        public void handle(HttpRequest request, HttpResponse response,
            ...
            String asset_name = uri.substring(i + "/script/asset/".length());
            File f = new File("core/com/limegroup/scripting/resources/assets/" + asset_name);
            String content_type = "application/binary";
            if(asset_name.endsWith("html") || asset_name.endsWith("htm")){
