...
public class LanguageFlagFactory {
    ...
    static {
        ...
        lc2cc.put("cy","UK"); //Welsh (Cymraeg) part of GB, part of UK 
        ...
        lc2cc.put("no","NO"); //Norsk Bokmal, Norway
        ...
        //lc2cc.put("sr","YU"); //Serbian, Serbia
    ...
    public static ImageIcon getFlag(String countryCode, String languageCode, boolean little) {
        ...
        if (countryCode != null && countryCode.length() > 0) {
            try {
                flag = GUIMediator.getThemeImage("flags/" + countryCode.toUpperCase(Locale.US));
