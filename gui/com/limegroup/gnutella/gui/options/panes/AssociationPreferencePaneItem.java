 ...
 * to choose if LimeWire should open magnet: links and .torrent files.
 */
public final class AssociationPreferencePaneItem extends AbstractPaneItem {
    ...
    public final static String LABEL = I18n.tr("You can use LimeWire to open certain filetypes and protocols. You can also instruct LimeWire to always regain these associations if another program takes them.");
	...
	public AssociationPreferencePaneItem() {
        ...
        panel.add(new JLabel(I18n.tr("Use LimeWire for...")), gbc);
